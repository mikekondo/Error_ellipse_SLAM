...
#include "CovarianceCalculator.h" //追加
#include "DataServer.h"           //追加
/////////////
...
private:
  ...
  ScanMatcher2D *smat;         // 近藤追記:スキャンマッチング
  CovarianceCalculator cvc;    //近藤追記
  Scan2D odom_prevScan;        // 1つ前のスキャン
public:
